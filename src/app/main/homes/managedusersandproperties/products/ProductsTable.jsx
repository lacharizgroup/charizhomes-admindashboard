...
heroicons-outline:minus-circle
...

			{
				...
				Cell: ({ row }) => (
					<div className="flex flex-wrap space-x-2">
					{row?.original?.listings?.length > 0 ? <><Chip
							
								component={Link}
						to={`/userlistings/managed-user-listings/${row.original.id}/userproperties`}
